...
public static class Scene1 {
    ...
    private static GameObject CreateWorldRoot() {
        ...
        return GameObjectBuilder.Root()
            ...
            .SetLayer("testLayer2")
            .SetLocalPosition(new Vector2(-100, 255))
            .SetLocalRotation(Rotation.FromDegrees(45))
            ...
            .SetLocalPosition(new Vector2(200, 100))
            ...
            .SetComponent(new PolygonCollider(true, new []{ new Vector2(-100, -100), new Vector2(-300, 100), new Vector2(100, 100), new Vector2(100, -100) }, ColliderState.TRIGGER, Vector2.Zero()))
