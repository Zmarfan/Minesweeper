...
public static class Scene1 {
    ...
    private static GameObject CreateWorldRoot() {
        ...
        return GameObjectBuilder.Root()
            ...
            .SetLayer("testLayer2")
            .SetPosition(new Vector2(300, 50))
            .SetComponent(new BoxCollider(true, ColliderState.TRIGGERING_COLLIDER,  new Vector2(100, 300), Vector2.Zero()))
            .SetComponent(RigidBodyBuilder
                .Builder()
                .SetVelocity(new Vector2(-40, 45))
                .Build()
            )
            .Build()
            ...
            .SetComponent(RigidBodyBuilder.Builder().Build())
            .SetPosition(new Vector2(-100, -100))
