...
public static class Scene1 {
    ...
    private static GameObject CreateWorldRoot() {
        ...
        return GameObjectBuilder.Root()
            ...
            .SetLayer("testLayer2")
            .SetPosition(new Vector2(-100, 255))
            .SetRotation(Rotation.FromDegrees(45))
            .SetComponent(new BoxCollider(true, ColliderState.TRIGGERING_COLLIDER, new Vector2(100, 100), Vector2.Zero()))
            // .SetComponent(new PolygonCollider(true, new []{ new Vector2(-300, -100), new Vector2(-200, 25), new Vector2(-100, 100), new Vector2(50, 50), new Vector2(100, 100), new Vector2(100, -100) }, ColliderState.TRIGGERING_COLLIDER, new Vector2(-200, 0)))
            .SetComponent(new RigidBody(true))
            .Build()
            .Transform.AddSibling("circle1")
            .SetPosition(new Vector2(200, 100))
            .SetComponent(new CircleCollider(true, ColliderState.TRIGGERING_COLLIDER, 150, Vector2.Zero()))
            .SetComponent(new RigidBody(true))
            .Build()
            .Transform.AddSibling("circle2")
            .SetPosition(new Vector2(200, 100))
            ...
            .SetComponent(new PolygonCollider(true, new []{ new Vector2(-100, -100), new Vector2(-100, 100), new Vector2(100, 100), new Vector2(100, -100) }, ColliderState.TRIGGER, Vector2.Zero()))
            ...
            .Build()
            .Transform.AddSibling("pixel collider")
            .SetComponent(TextureColliderBuilder.Builder(Texture.CreateSingle("pixelTest7")).SetState(ColliderState.TRIGGERING_COLLIDER).Build())
            .SetComponent(new RigidBody(true))
            .Build()
