...
public static class Scene1 {
    ...
    private static GameObject CreateWorldRoot() {
        ...
        return GameObjectBuilder.Root()
            ...
            .SetComponent(new CircleCollider(true, false, 200f, Vector2.Zero()))
            .Build()
            ...
            .Transform.AddSibling("circleCollider1")
            .SetPosition(new Vector2(200, 100))
            .SetComponent(new CircleCollider(true, false, 100f, Vector2.Zero()))
            .Build()
            .Transform.AddSibling("circleCollider1")
            .SetPosition(new Vector2(100, 100))
            .SetComponent(new CircleCollider(true, false, 120f, Vector2.Zero()))
            .Build()
