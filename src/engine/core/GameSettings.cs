...
public record GameSettings(bool debug, string title, int width, int height, List<Scene> scenes, List<InputListener> inputListeners, List<string> sortLayers, AudioSettings audioSettings) {
